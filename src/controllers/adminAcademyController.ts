...
export const createLesson = async (req: any, res: Response) => {
    try {
        ...
        let populatedLesson;
        try {
            populatedLesson = await Lesson.findById(lesson._id)
                .populate('author', 'name email');
        } catch (populateError) {
...
// @access  Private
export const getAcademyEngagement = async (req: Request, res: Response) => {
    try {
...
export const getAcademyStats = async (req: Request, res: Response) => {
    try {
